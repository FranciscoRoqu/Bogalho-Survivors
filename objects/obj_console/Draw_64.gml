...
draw_text_transformed(10, 90, "FPS: " + string(fps), 0.35, 0.35, 0)
draw_text_transformed(10, 110, "Absolute position: " + string(global.rooms[global.current_room_index].absolute_position), 0.35, 0.35, 0)